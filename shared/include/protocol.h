...
#define ACTION_JOIN_ROOM "JOIN_ROOM"
#define ACTION_SUBMIT_ANSWER "SUBMIT_ANSWER"
#define ACTION_FINISH_EXAM "FINISH_EXAM"
#define ACTION_GET_EXAM_STATE "GET_EXAM_STATE"
#define ACTION_GET_EXAM_REVIEW "GET_EXAM_REVIEW"
